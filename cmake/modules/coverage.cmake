...
set(COVERAGE_EXCLUDE_REGEX "(test/|build/)")
set(COVERAGE_PATH ${PROJECT_SOURCE_DIR}/coverage)
...
if(COVERAGE_BUILD)
    ...
    if(LLVM_COV_PATH AND LLVM_PROFDATA_PATH)
        set(PCR_HAVE_LLVM_COVERAGE_TOOLS TRUE)
    ...
    # mismatched function data warning bug with some of our app repos:
